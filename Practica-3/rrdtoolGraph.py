...
def grafica1(filename, time_start, time_end, title, db):  # Uso del Procesador 1
    try:
        rrdtool.graph(filename, "--start", str(time_start), "--end", str(time_end),
                      ...
                      "VDEF:var4=var,STDEV",
                      "CDEF:var5=var,60,GT,var,UN,IF",
                      "CDEF:var6=var,75,GT,var,UN,IF",
                      "CDEF:var7=var,90,GT,var,UN,IF",
                      "LINE3:var#00FF00:CPU 1",
                      "LINE3:var5#FFFF00:Umbral 1",
                      "LINE3:var6#FF8000:Umbral 2",
                      "LINE3:var7#FF0000:Umbral 3",
...
def grafica2(filename, time_start, time_end, title, db, var):  # Uso de la RAM
    try:
        rrdtool.graph(filename, "--start", str(time_start), "--end", str(time_end),
                      ...
                      "CDEF:var10=var5,60,GT,var5,UN,IF",
                      "CDEF:var11=var5,75,GT,var5,UN,IF",
                      "CDEF:var12=var5,90,GT,var5,UN,IF",
                      "LINE3:var5#0000FF:RAM",
                      "LINE3:var10#FFFF00:Umbral 1",
                      "LINE3:var11#FF8000:Umbral 2",
                      "LINE3:var12#FF0000:Umbral 3",
